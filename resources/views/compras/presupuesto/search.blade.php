<form action="{{url('compras/presupuesto')}}" method="GET" autocomplete="off" role="search">	
	<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
			<div class="form-group">
				<input type="text" class="form-control" name="searchText5" placeholder="Pedido..." value="{{$searchText5}}">
			</div>
		</div>
