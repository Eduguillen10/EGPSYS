...
@if($compra)
    <form action="{{ route('nota_debitoc.store') }}" method="POST" autocomplete="off">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="nro_nota_debito" class="form-control" value="{{ old('nro_nota_debito') }}" maxlength="20" required>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                            <div class="checkbox" style="margin-top: 28px;">
                                <label>
                                    <input type="checkbox" name="mueve_stock" value="1" {{ old('mueve_stock', '1') ? 'checked' : '' }}>
                                    Afecta stock
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-9 col-sm-9 col-md-9 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="concepto" class="form-control" value="{{ old('concepto') }}" maxlength="100" placeholder="Concepto del recargo o mercaderia adicional..." required>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">Detalle de la nota de debito</div>
                    <div class="panel-body">
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            <div class="form-group">
                                ...
                                @if($detalles->isEmpty())
                                    <p class="help-block">La compra no posee productos relacionados.</p>
                                @endif
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
...
@else
    <div class="alert alert-info">
        Seleccione una compra para cargar la nota de debito.
    </div>
@endif
