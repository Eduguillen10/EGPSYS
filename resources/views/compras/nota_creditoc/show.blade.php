...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h3>Detalle de Nota de Credito de Compra</h3>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                        <label>Compra</label>
                        <p>{{ $nota_creditoc->idcompra }} / {{ $nota_creditoc->nro_factura_compra }}</p>
                    </div>
                </div>
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                ...
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                        <label>Usuario</label>
                        <p>{{ $nota_creditoc->usuario }}</p>
                    </div>
                </div>
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                        <label>Estado</label>
                        <p>{{ $nota_creditoc->estado }}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                        ...
                        <p>{{ $nota_creditoc->fecha_factura ? date('d/m/Y', strtotime($nota_creditoc->fecha_factura)) : '' }}</p>
                    </div>
                </div>
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
