<form action="{{ route('nota_creditoc.index') }}" method="GET" autocomplete="off" role="search">
    <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
            <div class="form-group">
                <input type="text" class="form-control" name="searchText3" placeholder="Fecha..." value="{{ $searchText3 }}">
            </div>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
            <div class="form-group">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
            <div class="form-group">
                <div class="input-group">
                    <input type="text" class="form-control" name="searchText5" placeholder="Nro. Nota..." value="{{ $searchText5 }}">
