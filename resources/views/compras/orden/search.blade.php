<form action="{{url('compras/orden')}}" method="GET" autocomplete="off" role="search">
	<div class="row">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
			<div class="form-group">
				<input type="text" class="form-control" name="searchText4" placeholder="RazonSocial..." value="{{$searchText4}}">
			</div>
		</div>

        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
			<div class="form-group">
				<input type="text" class="form-control" name="searchText5" placeholder="Nro. Presupuesto..." value="{{$searchText5}}">
			</div>
		</div>
