<form action="{{url('ventas/venta')}}" method="GET" autocomplete="off" role="search">
<div class="row">
		...
		<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
			<div class="form-group">
				<input type="text" class="form-control" name="searchText6" placeholder="RUC - C.I..." value="{{$searchText6}}">
			</div>
		</div>	
   		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
			<div class="form-group">
