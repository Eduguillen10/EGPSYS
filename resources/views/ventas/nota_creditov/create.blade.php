...
@include('ventas.nota_creditov.modalelegir')
...
<form action="{{ url('ventas/nota_creditov') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
    @csrf
