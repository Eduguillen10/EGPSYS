...
<form action="{{ URL('ventas/nota_creditov/insertar_facturas') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-lg-5 col-sm-5 col-md-5 col-xs-12">
                        ...
                        <!-- Campo hidden para el número de factura -->
...
<script>
    ...
    $(document).ready(function() {
            // Llamar a la función datafactura() cuando se cargue la página
            datafactura();
        });
    ...
    function datafactura() {
        ...
        var nro_factura_value = parts[2].trim() + '-' + parts[3].trim() + '-' + parts[4].trim(); // Concatenar los campos del número de factura
        ...
        // Agregar un console.log para verificar si la función se está llamando correctamente
