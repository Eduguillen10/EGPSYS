    		...
    		<div class="panel-body">    			
						...
						<tbody>
							...
							@foreach($detalles as $det)
								<tr>
									...
									<td>{{ $det->producto }}</td>
									<td><input type="number" name="cantidad[{{ $det->idnota_creditov_detalle }}]" value="{{ $det->cantidad }}" min="1" required></td>
									<td>
										<input type="number" name="precio_venta[{{ $det->idnota_creditov_detalle }}]" value="{{ $det->precio_venta }}" min="1" required>
									</td>
									<td>
										<button type="button"
											class="btn btn-danger"
											data-toggle="modal"
											data-target="#modal-delete-{{ $det->idnota_creditov_detalle }}">
											Eliminar
										</button>
									</td>
								</tr>
				...
				<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12" id="guardar">
					<div class="form-group">
						...
						<button class="btn btn-light" onclick="window.location.href='{{ url('ventas/nota_creditov/create') }}'" type="button">
