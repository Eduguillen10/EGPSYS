...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h3>Administrar Caja <a href="{{ url('ventas/apertura/create') }}"><button class="btn btn-success">Nueva Apertura</button></a></h3>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-condensed table-hover">
                ...
                <tr>
                    ...
                    <td>
                        {{-- Arqueo Parcial: disponible SIEMPRE mientras esté abierto --}}
                        ...
                        {{-- Arqueo Final: solo si está cerrado --}}
